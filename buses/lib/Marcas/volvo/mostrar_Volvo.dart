...
class mostrar_Volvo extends StatelessWidget {
  const mostrar_Volvo({super.key, required this.carruselVolvo});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Caracteristicas del  ${carruselVolvo.name}',
                    ...
                    SizedBox(
                        child: ElevatedButton.icon(
                            ...
                            onPressed: () {
                              launchUrlString(carruselVolvo.enlace1);
                            },
