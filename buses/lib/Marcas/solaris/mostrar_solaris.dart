...
class mostrar_solaris extends StatelessWidget {
  final solaris carruselSolaris;
  const mostrar_solaris({super.key, required this.carruselSolaris});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Caracteristicas del  ${carruselSolaris.name}',
                    ...
                    SizedBox(
                        child: ElevatedButton.icon(
                            ...
                            onPressed: () {
                              launchUrlString(carruselSolaris.enlace);
                            },
