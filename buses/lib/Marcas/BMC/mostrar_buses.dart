...
class MostrarBuses extends StatelessWidget {
  final Buses carruselImages;
  const MostrarBuses({super.key, required this.carruselImages});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Caracterisitcas ${carruselImages.caracteristicas}',
                  ...
                  SizedBox(
                      child: ElevatedButton.icon(
                          ...
                          onPressed: () {
                            launchUrlString(carruselImages.enlace1);
                          },
                  ...
                  SizedBox(
                      child: ElevatedButton.icon(
                          ...
                          onPressed: () {
                            launchUrlString(carruselImages.enlace2);
                          },
                          style: TextButton.styleFrom(
                            shape: const StadiumBorder(),
                            foregroundColor:
